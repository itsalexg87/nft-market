const Banner = ({ parentStyles, childStyles, text }) => {
  return (
    <div className={`select-none relative w-full flex items-center z-0 overflow-hidden nft-gradient ${parentStyles}`}>
      <p className={`font-bold text-5xl text-white font-poppins leading-70 ${childStyles}`}>{text}</p>
